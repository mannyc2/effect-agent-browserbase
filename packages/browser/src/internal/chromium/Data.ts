...
/** Identifies this Chromium ownership lifetime, not a reusable endpoint. */
export class ChromiumReference extends Schema.Class<ChromiumReference>("ChromiumReference")({
  provider: Schema.Literal("chromium"),
  id: Identifier,
}) {}

export class ChromiumCleanupIssue extends Schema.Class<ChromiumCleanupIssue>(
...
export class ChromiumCleanupResult extends Schema.Class<ChromiumCleanupResult>(
  ...
  issues: Schema.Array(ChromiumCleanupIssue).check(Schema.isMaxLength(16)),
}) {}
...
export const ChromiumEndpoint = Text.check(
...
export const ChromiumLaunch = Schema.Struct({
...
export type ChromiumLaunch = typeof ChromiumLaunch.Type;
