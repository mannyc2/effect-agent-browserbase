...
import { type BrowserbaseInteractiveHost, type BrowserbaseSession } from "@effect-agent/platform-browserbase/interactive-browser";
...
const scoped: Same<Requirements<ReturnType<BrowserbaseInteractiveHost["Service"]["open"]>>, Scope.Scope> = true;
const hostErrors: Same<Effect.Error<ReturnType<BrowserbaseInteractiveHost["Service"]["open"]>>, BrowserbaseError | InteractiveBrowserError> = true;
...
const explicitOutcome: Same<BrowserbaseToolFailure["outcome"], "undispatched" | "rejected" | "unknown"> = true;
